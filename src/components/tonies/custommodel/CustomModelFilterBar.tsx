...
import type { FilterFieldKey } from "./types/customEditorTypes";

export type CustomModelFilterBarProps = {
    filterText: string;
...
export const CustomModelFilterBar: React.FC<CustomModelFilterBarProps> = ({
    filterText,
    setFilterText,
    seriesFilter,
    setSeriesFilter,
