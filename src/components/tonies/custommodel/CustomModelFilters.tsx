...
export const CustomModelFilters: React.FC<CustomModelFiltersProps> = ({
    ...
    const allowedFilterFields: FilterFieldKey[] = [
        "series",
        "model",
        "title",
        "episodes",
                    ...
                    children: (
                        <>
                            ...
                            >
                                ...
                                <Input
                                    placeholder={t(
                                        "tonies.tonies.filterBar.seriesFilterPlaceholder",
                                    )}
                                    value={seriesFilter}
                                ...
                                <Input
                                    placeholder={t(
                                        "tonies.tonies.filterBar.episodeFilterPlaceholder",
                                    )}
                                    value={episodeFilter}
                                ...
                                <Select<FilterFieldKey[]>
                                    mode="multiple"
                                    placeholder={t("tonies.customEditor.filterFieldsPlaceholder")}
                                    value={filterFields}
                                    style={{ width: "100%" }}
                                    onChange={(values: FilterFieldKey[]) => {
                                        const next = values.filter(
                                            (value): value is FilterFieldKey =>
                                                allowedFilterFields.includes(value),
                                        );
                                        setFilterFields(
                                            next.length > 0 ? next : ["series", "model"],
                                        );
                                    }}
                                    options={[
                                        {
                                        ...
                                        },
                                        {
                                            value: "title",
                                            label: t(
                                                "tonies.addNewCustomTonieModal.formfieldTitle",
                                            ),
                                        },
                                        {
                                            value: "episodes",
                                            label: t("tonies.addNewCustomTonieModal.episode"),
                                        },
                                        {
                                            value: "release",
                                        ...
                                        {
                                            value: "no",
                                            label: t("tonies.addNewCustomTonieModal.no"),
                                        },
                                    ]}
                                />
                            </Card>
