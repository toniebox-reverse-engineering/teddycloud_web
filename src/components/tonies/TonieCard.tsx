...
export const TonieCard: React.FC<{
  ...
  const handleBackgroundDownload = async () => {
    const url =
      process.env.REACT_APP_TEDDYCLOUD_API_URL + tonieCard.downloadTriggerUrl;
  ...
  const editModalFooter = (
    <>
      <Button
        ...
        disabled={
          activeSource === selectedSource && activeModel === selectedModel
        }
      >
    ...
    >
      ...
      <div>
        <Input
          ...
          addonBefore={
            <CloseOutlined onClick={() => setSelectedSource(activeSource)} />
          }
          addonAfter={
            <FolderOpenOutlined onClick={() => showFileSelectModal()} />
          }
        />
      </div>
      <Divider orientation="left" orientationMargin="0">
      ...
      <div>
        <p>
          <Input
            ...
            addonBefore={
              <CloseOutlined onClick={() => setSelectedModel(activeModel)} />
            }
          />
        </p>
        <TonieArticleSearch
