...
export const Step1Bootloader: React.FC<Step1PreparationsProps> = ({ hwTool }) => {
    ...
    const importantTBFilesData = [
        {
            ...
            file: "/cert/ca.der",
            description: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.importantTBFiles.caDer",
            ),
        },
        {
            ...
            description: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.importantTBFiles.privateDer",
            ),
        },
        {
            key: "/cert/client.der",
            ...
            description: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.importantTBFiles.clientDer",
            ),
        },
        {
            key: "/sys/mcuimg.bin",
            file: "/sys/mcuimg.bin",
            description: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.importantTBFiles.originalBootloader",
            ),
        },
        {
            key: "/sys/mcuimg1.bin",
            ...
            description: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.importantTBFiles.firstSlot",
            ),
        },
        {
            key: "/sys/mcuimg2.bin",
            ...
            description: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.importantTBFiles.secondSlot",
            ),
        },
        {
            key: "/sys/mcuimg3.bin",
            ...
            description: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.importantTBFiles.thirdSlot",
            ),
        },
        {
            ...
            description: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.importantTBFiles.mcuBootInfo",
            ),
        },
    ];
    ...
    const importantTBFilesColumns = [
        ...
        {
            title: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.importantTBFiles.description",
            ),
    ...
    const firstInstallationTab = (
        <>
            <b>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.firstInstallation.moveOriginal",
                )}
            </b>
            <Paragraph>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.firstInstallation.moveOriginalText1",
                )}
            </Paragraph>
            <Paragraph>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.firstInstallation.moveOriginalText2",
                )}
                <CodeSnippet
                    language="shell"
            ...
            <b>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.firstInstallation.installPreloader",
                )}
            </b>
            <Paragraph>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.firstInstallation.installPreloaderText1",
                )}
            </Paragraph>
            <CodeSnippet
                language="shell"
            ...
            <Paragraph>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.firstInstallation.installPreloaderText2",
                )}
            </Paragraph>
        </>
    );
    ...
    const existingInstallationUpdateTab = (
        <>
            <Paragraph>
                {t("tonieboxes.cc3200BoxFlashing.installingBootloader.existingInstallation.intro")}
            </Paragraph>
            <b>
                {t("tonieboxes.cc3200BoxFlashing.installingBootloader.existingInstallation.backup")}
            </b>
            <Paragraph>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.existingInstallation.backupText",
                )}
            </Paragraph>
            <CodeSnippet
                language="url"
                code={`http://*.*.*.*/api/ajax?cmd=get-flash-file&filepath=/sys/pre-img.bin`}
            />

            <b>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.existingInstallation.copyOverPreloader",
                )}
            </b>
            <Paragraph>
            ...
            <Paragraph>
                {t("tonieboxes.cc3200BoxFlashing.installingBootloader.existingInstallation.outro")}
            </Paragraph>
            <CodeSnippet
                language="url"
                code={`http://*.*.*.*/api/ajax?cmd=get-flash-file&filepath=/sys/mcuimg.bin`}
            />
        </>
    );
    ...
    const preloaderInstallation: TabsProps["items"] = [
        ...
        },
        {
            key: "updateExisting",
            label: t(
                "tonieboxes.cc3200BoxFlashing.installingBootloader.existingInstallation.title",
            ),
    ...
    return (
        <>
            ...
            <Paragraph>
                {t("tonieboxes.cc3200BoxFlashing.installingBootloader.verifyBackup")}
            </Paragraph>
            <Table
                dataSource={importantTBFilesData}
                columns={importantTBFilesColumns}
                pagination={false}
            />
            ...
            <Paragraph>
                <Paragraph>
                    {t("tonieboxes.cc3200BoxFlashing.installingBootloader.preface.intro")}
                </Paragraph>
                <Paragraph>
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li>
                                    {t(
                                        "tonieboxes.cc3200BoxFlashing.installingBootloader.firstInstallation.title",
                                    )}
                                </li>
                                <li>
                                    {t(
            ...
            <Paragraph>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.installingBootloaderStage2.intro",
                )}
            </Paragraph>
            <Paragraph>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.installingBootloaderStage2.text1",
                )}
            </Paragraph>
            <Paragraph>
                {t(
                    "tonieboxes.cc3200BoxFlashing.installingBootloader.installingBootloaderStage2.text2",
                )}
                <Link
