        ...
        <>
            ...
            <ul>
                ...
                <li>
                    ...
                    <Link
                        to="https://pip.pypa.io/en/stable/installation/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
            ...
            <Paragraph>
                {t("tonieboxes.boxFlashingCommon.installCC3200Tool.textAlternatively")}
            </Paragraph>
            <Paragraph>
                <CodeSnippet
                    language="shell"
            ...
            <Link
                to="https://github.com/toniebox-reverse-engineering/cc3200tool"
                target="_blank"
                rel="noopener noreferrer"
            >
