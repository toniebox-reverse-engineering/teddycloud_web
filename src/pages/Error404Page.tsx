...
export const Error404Page = () => {
    ...
    useEffect(() => {
        const fetchTonies = async () => {
            ...
            const centerVertical = 60;
            const centerHorizontal = 125;
            ...
            const shuffledImages = allImages.map((src, index) => {
                ...
                do {
                    top = Math.random() * ((parentHeight - 150) / parentHeight) * parentHeight; // Random top position
                    left = Math.random() * ((parentWidth - 150) / parentWidth) * parentWidth; // Random left position
                } while (
                    left > centerX - centerHorizontal - 150 &&
                    left < centerX + centerHorizontal &&
                    top > centerY - centerVertical - 150 &&
                    top < centerY + centerVertical
                );
    ...
    return (
        <>
            ...
            <StyledLayout>
                ...
                <StyledBreadcrumb
                    items={[{ title: t("home.navigationTitle") }, { title: t("home.404.navigationTitle") }]}
                />
                <StyledContent>
                    <Paragraph>
                        <div
                        ...
                        >
                            ...
                            >
                                <h1>{t("home.404.title")}</h1>
                                <p>{t("home.404.description")}</p>
                            </div>
