...
export const LibraryPage = () => {
    ...
    const view =
        searchParams.get("view") === VIEW_CUSTOM_IMAGES ? VIEW_CUSTOM_IMAGES : VIEW_LIBRARY;
                ...
                <StyledContent>
                    ...
                    >
                        ...
                        <Segmented
                            ...
                            options={[
                                {
                                    label: t("tonies.libraryAudio.navigationTitle"),
                                    value: VIEW_LIBRARY,
                                },
                                {
                                    label: t("tonies.customImages.navigationTitle"),
                                    value: VIEW_CUSTOM_IMAGES,
                                },
                            ]}
                        />
                    </div>
