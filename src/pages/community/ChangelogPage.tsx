    ...
    const changelogData = [
        {
            ...
            changes: [
                ...
                "gui: WIP Added support of new TeddyCloud Plugin feature (Backend implementation missing) https://github.com/toniebox-reverse-engineering/teddycloud/issues/342",
